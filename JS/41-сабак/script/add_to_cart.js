...
function total_price(){
	...
	document.querySelectorAll('.curr__number .total__price')[0].innerHTML = `$ ${total_sum} `
}

function total_count(){
	var item_count = document.querySelectorAll(".bag__item").length
	document.querySelectorAll(".total-count")[0].innerHTML =  `${item_count} / `
}

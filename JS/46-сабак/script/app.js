...
// var result = prompt('Сен канча жаштасын?', 85);
...
// })
 ...
 class Animal {
    ...
    info(){
        console.log(`${this.name} made some voice. | Color: ${this.color} `)
    }
...
class Cats extends Animal{
    ...
    show(){
        super.info()
        console.log('This cat can ' + this.ability)
    }
}

const myCats = new Cats({
    name: 'Momo',
    color: 'yellow',
    age: 2,
    ability: "Fly"
...
// const myDog = new Animal({name: 'Belka', color: 'white'})
// const myCat = new Animal({name: 'Murka', color: 'brown'})
